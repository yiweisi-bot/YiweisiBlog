export default function AdSection() {
  const ads = [
    ...
    },
    {
      ...
      description: "支持 Doubao、GLM、DeepSeek、Kimi 等模型，工具不限，现在订阅折上 9 折，低至 8.9 元，订阅越多越划算！",
  ...
  return (
    <section className="mb-16 sm:mb-20 py-8 bg-gradient-to-b from-background to-muted/30">
